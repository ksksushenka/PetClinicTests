...
namespace PetClinicTests.Pages
{
    public class MenuBar: BasePage
    {
        ...
        private ILocator _ownersDropDown => _page.GetByRole(AriaRole.Button, new() {Name = "OwnersTable", Exact = true});
        ...
        private ILocator _specialtiesButton => _page.GetByRole(AriaRole.Link, new() { Name = "SpecialtiesTable" });
